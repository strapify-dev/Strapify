...
function convertSiteDataToFileReadyContent(siteData) {
  ...
  for (let i = 0; i < siteData.headScriptsData.length; i++) {
    ...
    parentNode.insertAdjacentHTML(
      "beforeend",
      `<script src=./${siteData.headScriptsData[i].name}.js>${
        "" /*siteData.headScriptsData[i].text*/
      }</script>`
    );
  ...
  for (let i = 0; i < siteData.bodyScriptsData.length; i++) {
    ...
    parentNode.insertAdjacentHTML(
      "beforeend",
      `<script src=./${siteData.bodyScriptsData[i].name}.js>${
        "" /*siteData.bodyScriptsData[i].text*/
      }</script>`
    );
