...
function reinitializeIX2() {
  ...
  function initIX2() {
    try {
      /* eslint-disable */console.log(...oo_oo(`1725239506_0`, "reinitializing ix2"));
    ...
    componentElms.forEach(componentElm => {
      ...
      for (let attribute of [..._Strapify_js__WEBPACK_IMPORTED_MODULE_0__["default"].validStrapifyFieldAttributes, "strapi-relation", "strapi-repeatable"]) {
        ...
        if (attributeValue) {
          ...
          for (let arg of args) {
            if (arg) {
              const _arg = _Strapify_js__WEBPACK_IMPORTED_MODULE_0__["default"].removeQueryStringVariableReferences(arg);
              // if (_arg.includes(".")) {
